# -*- coding: utf-8 -*-
"""Team Charlie Indeed Scraper 2.0

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1MpsC1BRAC3nkEYTs0Z_dV45yGjKV1loz
"""
    ...
    if response.status_code == 200:
        ...
        if 'hits' in data and len(data['hits']) > 0:
            ...
            with open(csv_file, mode='w', newline='', encoding='utf-8') as file:
                ...
                writer.writerow(["company_name", "formatted_relative_time", "id", "link", "title", "location", "pub_date_ts_milli", "salary"])
